...
```{r example1, fig.width=6, fig.height=3.5, fig.align='center'}
library(relliptical)
...
```{r example3, fig.width=6, fig.height=3.5, fig.align='center'}
...
```{r example2.0, fig.width=6, fig.height=3.5, fig.align='center'}
...
```{r example2.1, fig.width=6, fig.height=3.5, fig.align='center'}
